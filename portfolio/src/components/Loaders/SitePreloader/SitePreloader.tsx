...
import {
  variantsLogoMainFadeIn,
  variantsPreloaderContainer,
  variantesPreloaderSplashBox,
  variantsLogoMainSlideOut,
  variantsLogoSecondarySlideIn,
  variantsLogoSecondary,
  variantsLogoSecondaryPath,
...
const SitePreloader = () => {
  return (
    <motion.div
      initial="initial"
      animate="animate"
      variants={variantsPreloaderContainer}
      className={styles.sitePreloader}
    >
      <motion.div
        variants={variantesPreloaderSplashBox}
        className={styles.blackbg}
      ></motion.div>
      <div className={styles.logo__container}>
        <motion.div variants={variantsLogoMainSlideOut}>
          {/*  Logo */}
          <motion.svg
            variants={variantsLogoMainFadeIn}
          ...
          >
            <g id="Layer_2" data-name="Layer 2">
              <g id="Layer_1-2" data-name="Layer 1">
                <rect
                  className={styles.cls_logo_1}
                  width="347"
                  height="347"
                  rx="173.5"
                />
                <path
                  className={styles.cls_logo_2}
                  d="M234.4,69.87a13,13,0,0,1-.1,1.67h.1V194a95,95,0,0,1-66,90.45,92.86,92.86,0,0,1-26.63,4.46,4.3,4.3,0,0,0,1,.07h-3.33a45.88,45.88,0,0,1-44.73-35.79,48.18,48.18,0,0,1-1.09-10A46.32,46.32,0,0,1,94.73,233,58.63,58.63,0,0,0,137,253.14h.44c.5,0,1.06,0,1.6,0h.73c.93,0,1.83,0,2.73-.1l1.4-.1c.87-.06,1.77-.16,2.64-.26.4,0,.83-.1,1.23-.17,1.07-.17,2.1-.33,3.13-.57h.07c1-.2,2.07-.46,3.07-.73.16,0,.33-.1.49-.13,0,0,0,0,.07,0,1.27-.26,2.5-.6,3.73-1a14.16,14.16,0,0,0,1.47-.5,54.23,54.23,0,0,0,24.46-16.13,54.88,54.88,0,0,0,11.47-21.17s0,0,0-.06a56.29,56.29,0,0,0,2-14.9V95.2a45.77,45.77,0,0,1,30.2-39.29,41.43,41.43,0,0,1,6.46-1.8Z"
                />
              </g>
            </g>
          </motion.svg>
            ...
            <g id="Layer_2" data-name="Layer 2">
              <g id="Layer_1-2" data-name="Layer 1">
                ...
                <motion.path
                  variants={variantsLogoSecondaryPath}
                  className={styles.cls_logo_3}
                  d="M240.33,4.55a1.05,1.05,0,0,1-.07.5c-1.46,3.37-5,12.33-7.64,19.4-1.11,3-2.05,5.56-2.62,7.31a1.1,1.1,0,0,1,.28.56,1.15,1.15,0,0,1-.1.55c-.26.51-.46.88-.63,1.15a2.78,2.78,0,0,1-.26.37,1.45,1.45,0,0,1-.27.23,1,1,0,0,1-1,0,.92.92,0,0,1-.5-.69,1.21,1.21,0,0,1,0-.31,3.07,3.07,0,0,1,.07-.42c.06-.28.16-.63.29-1.07.54-1.75,1.65-4.82,3-8.37,2.65-7.09,6.17-16,7.67-19.48a1,1,0,0,1,.74-.56h0A.93.93,0,0,1,240.33,4.55Z"
                />
                <motion.path
                  variants={variantsLogoSecondaryPath}
                  className={styles.cls_logo_3}
                  d="M240.26,15.67a1,1,0,0,1,1.31.34,8.48,8.48,0,0,0,1.51,1.48,9.4,9.4,0,0,1,2.08,2.19,1.78,1.78,0,0,1-.85,2.76l-1,.57a24,24,0,0,1-5.13,2.48,1,1,0,0,1-1.15-.72,1,1,0,0,1,.72-1.15,23.76,23.76,0,0,0,4.63-2.28l1-.56c.11-.07.13-.12.1-.17A8.1,8.1,0,0,0,241.84,19a9,9,0,0,1-1.91-2A1,1,0,0,1,240.26,15.67Z"
                />
              </g>
            </g>
          </motion.svg>
